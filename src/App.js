...
function App() {
  ...
  return (
    <>
      ...
      <div className={alerts.warn} role="alert">
        <strong>Oops!</strong> Wrong input.
        <button type="button" className="close" onClick={() => hideShowAlert('warn')}>
      ...
      <div className={alerts.danger} role="alert">
        ...
        <button type="button" className="close" onClick={() => hideShowAlert('danger')}>
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
